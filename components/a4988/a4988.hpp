...
namespace a4988 {
    ...
    public:
        ...
        void set_frequency(this A4988& self, std::uint32_t frequency) noexcept;

        void set_microstep(this A4988& self, Microstep microstep) noexcept;
        ...
        void set_direction(this A4988& self, Direction direction) noexcept;
        ...
        void set_reset(this A4988 const& self, bool reset = true) noexcept;
        void set_enable(this A4988 const& self, bool enable = true) noexcept;
        void set_sleep(this A4988 const& self, bool sleep = true) noexcept;
    ...
    private:
        ...
        void pulse_set_freq(this A4988 const& self, std::uint32_t freq) noexcept;

        void gpio_init(this A4988 const& self) noexcept;
        void gpio_deinit(this A4988 const& self) noexcept;
        void gpio_write_pin(this A4988 const& self, std::uint16_t pin, bool state) noexcept;
    };
