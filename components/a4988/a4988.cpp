...
namespace a4988 {
    ...
    void A4988::set_frequency(this A4988& self, std::uint32_t frequency) noexcept
    {
        self.pulse_set_freq(frequency);
    }

    void A4988::set_microstep(this A4988& self, Microstep microstep) noexcept
    {
        switch (microstep) {
            case Microstep::FULL:
    ...
    void A4988::set_direction(this A4988& self, Direction direction) noexcept
    {
        switch (direction) {
    ...
    void A4988::set_reset(this A4988 const& self, bool reset) noexcept
    {
        self.gpio_write_pin(self.config.pin_enable, !reset);
    }

    void A4988::set_enable(this A4988 const& self, bool enable) noexcept
    {
        self.gpio_write_pin(self.config.pin_enable, !enable);
    }

    void A4988::set_sleep(this A4988 const& self, bool sleep) noexcept
    {
    ...
    void A4988::pulse_set_freq(this A4988 const& self, std::uint32_t freq) noexcept
    {
    ...
    void A4988::gpio_write_pin(this A4988 const& self, std::uint16_t pin, bool state) noexcept
    {
