...
namespace mpu6050 {
    ...
    void MPU6050_DMP::set_otp_bank_valid(bool valid) const noexcept
    {
    ...
    void MPU6050_DMP::set_x_gyro_offset_tc(std::uint8_t offset) const noexcept
    {
    ...
    void MPU6050_DMP::set_y_gyro_offset_tc(std::uint8_t offset) const noexcept
    {
    ...
    void MPU6050_DMP::set_z_gyro_offset_tc(std::uint8_t offset) const noexcept
    {
    ...
    void MPU6050_DMP::set_x_fine_gain(std::uint8_t gain) const noexcept
    {
        this->mpu6050.write_byte(std::to_underlying(RA::X_FINE_GAIN), gain);
    }

    void MPU6050_DMP::set_y_fine_gain(std::uint8_t gain) const noexcept
    {
        this->mpu6050.write_byte(std::to_underlying(RA::Y_FINE_GAIN), gain);
    }

    void MPU6050_DMP::set_z_fine_gain(std::uint8_t gain) const noexcept
    {
        this->mpu6050.write_byte(std::to_underlying(RA::Z_FINE_GAIN), gain);
    }

    void MPU6050_DMP::set_x_accel_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
        this->mpu6050.write_bytes(std::to_underlying(RA::XA_OFFS_H), buffer, sizeof(buffer));
    }

    void MPU6050_DMP::set_y_accel_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
        this->mpu6050.write_bytes(std::to_underlying(RA::YA_OFFS_H), buffer, sizeof(buffer));
    }

    void MPU6050_DMP::set_z_accel_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
    ...
    void MPU6050_DMP::set_x_gyro_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
        this->mpu6050.write_bytes(std::to_underlying(RA::XG_OFFS_USRH), buffer, sizeof(buffer));
    }

    void MPU6050_DMP::set_y_gyro_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
        this->mpu6050.write_bytes(std::to_underlying(RA::YG_OFFS_USRH), buffer, sizeof(buffer));
    }

    void MPU6050_DMP::set_z_gyro_offset(std::int16_t offset) const noexcept
    {
        std::uint8_t buffer[2] = {offset >> 8, offset};
    ...
    void MPU6050_DMP::set_int_pll_ready_enabled(bool enabled) const noexcept
    {
    ...
    void MPU6050_DMP::set_int_dmp_enabled(bool enabled) const noexcept
    {
        this->mpu6050.write_bit(std::to_underlying(RA::INT_ENABLE),
                                enabled,
    ...
    void MPU6050_DMP::set_dmp_enabled(bool enabled) const noexcept
    {
    ...
    void MPU6050_DMP::set_memory_bank(std::uint8_t bank,
                                      bool prefetch_enabled,
                                      bool user_bank) const noexcept
    {
    ...
    void MPU6050_DMP::set_memory_start_address(std::uint8_t address) const noexcept
    {
    ...
    void MPU6050_DMP::write_memory_byte(std::uint8_t data) const noexcept
    {
    ...
    void MPU6050_DMP::set_dmp_config1(std::uint8_t config) const noexcept
    {
        this->mpu6050.write_byte(std::to_underlying(RA::DMP_CFG_1), config);
    }

    void MPU6050_DMP::set_dmp_config2(std::uint8_t config) const noexcept
    {
