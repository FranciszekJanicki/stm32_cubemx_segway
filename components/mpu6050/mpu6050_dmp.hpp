...
namespace mpu6050 {
    ...
    private:
        ...
        void set_otp_bank_valid(bool enabled) const noexcept;

        void set_x_gyro_offset_tc(std::uint8_t offset) const noexcept;
        void set_y_gyro_offset_tc(std::uint8_t offset) const noexcept;
        void set_z_gyro_offset_tc(std::uint8_t offset) const noexcept;

        void set_x_fine_gain(std::uint8_t gain) const noexcept;
        void set_y_fine_gain(std::uint8_t gain) const noexcept;
        void set_z_fine_gain(std::uint8_t gain) const noexcept;

        void set_x_accel_offset(std::int16_t offset) const noexcept;
        void set_y_accel_offset(std::int16_t offset) const noexcept;
        void set_z_accel_offset(std::int16_t offset) const noexcept;

        void set_x_gyro_offset(std::int16_t offset) const noexcept;
        void set_y_gyro_offset(std::int16_t offset) const noexcept;
        void set_z_gyro_offset(std::int16_t offset) const noexcept;

        void set_int_pll_ready_enabled(bool enabled) const noexcept;
        void set_int_dmp_enabled(bool enabled) const noexcept;
        ...
        void set_dmp_enabled(bool enabled) const noexcept;
        void reset_dmp() const noexcept;

        void set_memory_bank(std::uint8_t bank,
                             bool prefetch_enabled = false,
                             bool user_bank = false) const noexcept;
        void set_memory_start_address(std::uint8_t address) const noexcept;
        ...
        void set_dmp_config1(std::uint8_t config) const noexcept;
        void set_dmp_config2(std::uint8_t config) const noexcept;
