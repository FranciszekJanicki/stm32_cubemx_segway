...
typedef struct {
    ...
    uint32_t
        EnhancedDescriptorFormat; /*!< Enables the enhanced descriptor format.
...
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYREQ_ANNOUNCE                                                                      \
    0x00000500U /* PdelayReq message (peer-to-peer transparent clock) or Announce message (Ordinary or Boundary clock) \
                 */
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESP_MANAG                                                                    \
    0x00000600U /* PdelayResp message (peer-to-peer transparent clock) or Management message (Ordinary or Boundary \
                   clock)  */
#define ETH_DMAPTPRXDESC_PTPMT_PDELAYRESPFOLLOWUP_SIGNAL                                                         \
    0x00000700U /* PdelayRespFollowUp message (peer-to-peer transparent clock) or Signaling message (Ordinary or \
                   Boundary clock) */
