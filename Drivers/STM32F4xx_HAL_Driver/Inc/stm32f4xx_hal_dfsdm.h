...
typedef struct {
    ...
    uint32_t DFSDM2BitClkDistribution; /*!< Distribution of the DFSDM2 bitstream clock gated by TIM3 OC1 or TIM3 OC2 or
                                          TIM3 OC3 or TIM3 OC4. This parameter can be a value of @ref
                                          DFSDM_2_BIT_STREAM_DISTRIBUTION
...
#define DFSDM_FILTER_EXT_TRIG_TIM10_OC1 \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_1) /*!< For DFSDM1 filter 0 and 1 and DFSDM2 filter 0, 1 and 2 */
...
#define DFSDM_FILTER_EXT_TRIG_TIM6_TRGO \
    (DFSDM_FLTCR1_JEXTSEL_0 | DFSDM_FLTCR1_JEXTSEL_2) /*!< For DFSDM1 filter 0 and 1 and DFSDM2 filter 0 and 1 */
...
#define DFSDM_FILTER_EXT_TRIG_EXTI11 (DFSDM_FLTCR1_JEXTSEL_1 | DFSDM_FLTCR1_JEXTSEL_2) /*!< For DFSDM1 filter 0 and \
                                                                                          1*/
...
#define IS_DFSDM_DELAY_CLOCK(CLOCK) (((CLOCK) == HAL_MCHDLY_CLOCK_DFSDM2) || ((CLOCK) == HAL_MCHDLY_CLOCK_DFSDM1))
#else
#define IS_DFSDM_FILTER_EXT_TRIG(TRIG)                                                             \
    (((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM1_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM3_TRGO) || \
     ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM8_TRGO) || ((TRIG) == DFSDM_FILTER_EXT_TRIG_TIM10_OC1) || \
...
#define IS_DFSDM1_FILTER_INSTANCE(INSTANCE) (((INSTANCE) == DFSDM1_Filter0) || ((INSTANCE) == DFSDM1_Filter1))
...
#define IS_DFSDM_BITSTREM_CLK_DISTRIBUTION(DISTRIBUTION)                                               \
    (((DISTRIBUTION) == HAL_DFSDM1_CLKIN0_TIM4OC2) || ((DISTRIBUTION) == HAL_DFSDM1_CLKIN2_TIM4OC2) || \
     ((DISTRIBUTION) == HAL_DFSDM1_CLKIN1_TIM4OC1) || ((DISTRIBUTION) == HAL_DFSDM1_CLKIN3_TIM4OC1) || \
     ((DISTRIBUTION) == HAL_DFSDM2_CLKIN0_TIM3OC4) || ((DISTRIBUTION) == HAL_DFSDM2_CLKIN4_TIM3OC4) || \
     ((DISTRIBUTION) == HAL_DFSDM2_CLKIN1_TIM3OC3) || ((DISTRIBUTION) == HAL_DFSDM2_CLKIN5_TIM3OC3) || \
     ((DISTRIBUTION) == HAL_DFSDM2_CLKIN2_TIM3OC2) || ((DISTRIBUTION) == HAL_DFSDM2_CLKIN6_TIM3OC2) || \
     ((DISTRIBUTION) == HAL_DFSDM2_CLKIN3_TIM3OC1) || ((DISTRIBUTION) == HAL_DFSDM2_CLKIN7_TIM3OC1))
#define IS_DFSDM_DFSDM1_CLKOUT(CLKOUT) (((CLKOUT) == DFSDM1_CKOUT_DFSDM2_CKOUT) || ((CLKOUT) == DFSDM1_CKOUT_DFSDM1))
#define IS_DFSDM_DFSDM2_CLKOUT(CLKOUT) (((CLKOUT) == DFSDM2_CKOUT_DFSDM2_CKOUT) || ((CLKOUT) == DFSDM2_CKOUT_DFSDM2))
#define IS_DFSDM_DFSDM1_CLKIN(CLKIN) (((CLKIN) == DFSDM1_CKIN_DFSDM2_CKOUT) || ((CLKIN) == DFSDM1_CKIN_PAD))
#define IS_DFSDM_DFSDM2_CLKIN(CLKIN) (((CLKIN) == DFSDM2_CKIN_DFSDM2_CKOUT) || ((CLKIN) == DFSDM2_CKIN_PAD))
#define IS_DFSDM_DFSDM1_BIT_CLK(CLK)                                                         \
    (((CLK) == DFSDM1_T4_OC2_BITSTREAM_CKIN0) || ((CLK) == DFSDM1_T4_OC2_BITSTREAM_CKIN2) || \
     ((CLK) == DFSDM1_T4_OC1_BITSTREAM_CKIN3) || ((CLK) == DFSDM1_T4_OC1_BITSTREAM_CKIN1) || ((CLK) <= 0x30U))
...
#define IS_DFSDM_DFSDM2_BIT_CLK(CLK)                                                         \
    (((CLK) == DFSDM2_T3_OC4_BITSTREAM_CKIN0) || ((CLK) == DFSDM2_T3_OC4_BITSTREAM_CKIN4) || \
     ...
     ((CLK) == DFSDM2_T3_OC1_BITSTREAM_CKIN3) || ((CLK) == DFSDM2_T3_OC1_BITSTREAM_CKIN7) || ((CLK) <= 0x1E000U))

#define IS_DFSDM_DFSDM1_DATA_DISTRIBUTION(DISTRIBUTION)                                                    \
    (((DISTRIBUTION) == DFSDM1_DATIN0_TO_DATIN0_PAD) || ((DISTRIBUTION) == DFSDM1_DATIN0_TO_DATIN1_PAD) || \
     ((DISTRIBUTION) == DFSDM1_DATIN2_TO_DATIN2_PAD) || ((DISTRIBUTION) == DFSDM1_DATIN2_TO_DATIN3_PAD) || \
     ((DISTRIBUTION) <= 0xCU))

#define IS_DFSDM_DFSDM2_DATA_DISTRIBUTION(DISTRIBUTION)                                                    \
    (((DISTRIBUTION) == DFSDM2_DATIN0_TO_DATIN0_PAD) || ((DISTRIBUTION) == DFSDM2_DATIN0_TO_DATIN1_PAD) || \
     ((DISTRIBUTION) == DFSDM2_DATIN2_TO_DATIN2_PAD) || ((DISTRIBUTION) == DFSDM2_DATIN2_TO_DATIN3_PAD) || \
     ((DISTRIBUTION) == DFSDM2_DATIN4_TO_DATIN4_PAD) || ((DISTRIBUTION) == DFSDM2_DATIN4_TO_DATIN5_PAD) || \
     ((DISTRIBUTION) == DFSDM2_DATIN6_TO_DATIN6_PAD) || ((DISTRIBUTION) == DFSDM2_DATIN6_TO_DATIN7_PAD) || \
