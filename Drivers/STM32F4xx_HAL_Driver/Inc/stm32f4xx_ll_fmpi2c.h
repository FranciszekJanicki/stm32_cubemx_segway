...
#define LL_FMPI2C_OWNADDRESS2_MASK07                  \
    FMPI2C_OAR2_OA2MASK07 /*!< No comparison is done. \
...
#define LL_FMPI2C_MODE_AUTOEND                               \
    FMPI2C_CR2_AUTOEND /*!< Enable FMPI2C Automatic end mode \
                      with no HW PEC comparison.  */
#define LL_FMPI2C_MODE_SOFTEND                       \
    0x00000000U /*!< Enable FMPI2C Software end mode \
                  with no HW PEC comparison.  */
#define LL_FMPI2C_MODE_SMBUS_RELOAD                               \
    LL_FMPI2C_MODE_RELOAD /*!< Enable FMPSMBUS Automatic end mode \
                         with HW PEC comparison.     */
#define LL_FMPI2C_MODE_SMBUS_AUTOEND_NO_PEC                        \
    LL_FMPI2C_MODE_AUTOEND /*!< Enable FMPSMBUS Automatic end mode \
                          with HW PEC comparison.     */
#define LL_FMPI2C_MODE_SMBUS_SOFTEND_NO_PEC                       \
    LL_FMPI2C_MODE_SOFTEND /*!< Enable FMPSMBUS Software end mode \
                          with HW PEC comparison.     */
...
#define LL_FMPI2C_GENERATE_RESTART_10BIT_READ \
    (uint32_t)(0x80000000U | FMPI2C_CR2_START | FMPI2C_CR2_RD_WRN | FMPI2C_CR2_HEAD10R)
...
#define LL_FMPI2C_DIRECTION_READ                         \
    FMPI2C_ISR_DIR /*!< Read transfer request by master, \
...
#define LL_FMPI2C_DMA_REG_DATA_TRANSMIT                    \
    0x00000000U /*!< Get address of data register used for \
                  transmission */
#define LL_FMPI2C_DMA_REG_DATA_RECEIVE                     \
 ...
 * @{
 */
#define LL_FMPI2C_FMPSMBUS_TIMEOUTA_MODE_SCL_LOW \
    0x00000000U /*!< TimeoutA is used to detect  \
               SCL low level timeout.              */
#define LL_FMPI2C_FMPSMBUS_TIMEOUTA_MODE_SDA_SCL_HIGH     \
    FMPI2C_TIMEOUTR_TIDLE /*!< TimeoutA is used to detect \
...
#define LL_FMPI2C_FMPSMBUS_TIMEOUTB                       \
    FMPI2C_TIMEOUTR_TEXTEN /*!< TimeoutB (extended clock) \
                       enable bit                   */
#define LL_FMPI2C_FMPSMBUS_ALL_TIMEOUT                                                       \
    (uint32_t)(FMPI2C_TIMEOUTR_TIMOUTEN | FMPI2C_TIMEOUTR_TEXTEN) /*!< TimeoutA and TimeoutB \
...
LL_FMPI2C_ConfigSMBusTimeout(FMPI2C_TypeDef* FMPI2Cx, uint32_t TimeoutA, uint32_t TimeoutAMode, uint32_t TimeoutB)
{
...
{
    return ((READ_BIT(FMPI2Cx->TIMEOUTR, (FMPI2C_TIMEOUTR_TIMOUTEN | FMPI2C_TIMEOUTR_TEXTEN)) == (ClockTimeout)) ? 1UL
                                                                                                                 : 0UL);
}
                                              ...
                                              uint32_t Request)
{
    ...
    uint32_t tmp = ((uint32_t)(((uint32_t)SlaveAddr & FMPI2C_CR2_SADD) | ((uint32_t)SlaveAddrSize & FMPI2C_CR2_ADD10) |
    ...
    MODIFY_REG(FMPI2Cx->CR2,
               FMPI2C_CR2_SADD | FMPI2C_CR2_ADD10 |
                   (FMPI2C_CR2_RD_WRN & (uint32_t)(Request >> (31U - FMPI2C_CR2_RD_WRN_Pos))) | FMPI2C_CR2_START |
                   FMPI2C_CR2_STOP | FMPI2C_CR2_RELOAD | FMPI2C_CR2_NBYTES | FMPI2C_CR2_AUTOEND | FMPI2C_CR2_HEAD10R,
               tmp);
}
