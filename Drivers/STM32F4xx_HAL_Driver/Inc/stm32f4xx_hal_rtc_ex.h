...
#define RTC_TAMPERFILTER_2SAMPLE                         \
    RTC_TAFCR_TAMPFLT_0 /*!< Tamper is activated after 2 \
                               consecutive samples at the active level */
#define RTC_TAMPERFILTER_4SAMPLE                         \
    RTC_TAFCR_TAMPFLT_1 /*!< Tamper is activated after 4 \
                               consecutive samples at the active level */
#define RTC_TAMPERFILTER_8SAMPLE                       \
    RTC_TAFCR_TAMPFLT /*!< Tamper is activated after 8 \
                             consecutive samples at the active level */
#define RTC_TAMPERFILTER_MASK                               \
    RTC_TAFCR_TAMPFLT /*!< Masking all bits except those of \
                             field TAMPFLT                           */
/**
 * @}
 */
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV16384                      \
    RTC_TAFCR_TAMPFREQ_0 /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096                                                \
    (RTC_TAFCR_TAMPFREQ_0 | RTC_TAFCR_TAMPFREQ_1) /*!< Each of the tamper inputs are sampled \
...
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024                                                \
    (RTC_TAFCR_TAMPFREQ_0 | RTC_TAFCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled \
                                                          with a frequency =  RTCCLK / 1024  */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV512                                                 \
    (RTC_TAFCR_TAMPFREQ_1 | RTC_TAFCR_TAMPFREQ_2) /*!< Each of the tamper inputs are sampled \
                                                          with a frequency =  RTCCLK / 512   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV256                      \
    RTC_TAFCR_TAMPFREQ /*!< Each of the tamper inputs are sampled \
                              with a frequency =  RTCCLK / 256   */
#define RTC_TAMPERSAMPLINGFREQ_RTCCLK_MASK                   \
    RTC_TAFCR_TAMPFREQ /*!< Masking all bits except those of \
                              field TAMPFREQ                     */
/**
 * @}
 */
...
#define RTC_TAMPERPRECHARGEDURATION_2RTCCLK                      \
    RTC_TAFCR_TAMPPRCH_0 /*!< Tamper pins are pre-charged before \
                                sampling during 2 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_4RTCCLK                      \
    RTC_TAFCR_TAMPPRCH_1 /*!< Tamper pins are pre-charged before \
                                sampling during 4 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_8RTCCLK                    \
    RTC_TAFCR_TAMPPRCH /*!< Tamper pins are pre-charged before \
                              sampling during 8 RTCCLK cycles */
#define RTC_TAMPERPRECHARGEDURATION_MASK                     \
    RTC_TAFCR_TAMPPRCH /*!< Masking all bits except those of \
                              field TAMPPRCH                  */
/**
 * @}
 */
...
HAL_StatusTypeDef
HAL_RTCEx_SetTimeStamp(RTC_HandleTypeDef* hrtc, uint32_t RTC_TimeStampEdge, uint32_t RTC_TimeStampPin);
HAL_StatusTypeDef
HAL_RTCEx_SetTimeStamp_IT(RTC_HandleTypeDef* hrtc, uint32_t RTC_TimeStampEdge, uint32_t RTC_TimeStampPin);
...
#define RTC_EXTI_LINE_TAMPER_TIMESTAMP_EVENT \
    EXTI_IMR_MR21 /*!< External interrupt line 21 Connected to the RTC Tamper and Timestamp event */
#define RTC_EXTI_LINE_WAKEUPTIMER_EVENT \
    EXTI_IMR_MR22 /*!< External interrupt line 22 Connected to the RTC Wakeup event */
/**
 * @}
 */
...
/* Masks Definition */
#if defined(RTC_TAMPER2_SUPPORT)
#define RTC_TAMPER_ENABLE_BITS_MASK ((uint32_t)(RTC_TAMPER_1 | RTC_TAMPER_2))
...
#define IS_RTC_TAMPER_SAMPLING_FREQ(FREQ)                                                                        \
    (((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV32768) || ((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV16384) || \
     ((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV8192) || ((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV4096) ||   \
     ((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV2048) || ((FREQ) == RTC_TAMPERSAMPLINGFREQ_RTCCLK_DIV1024) ||   \
...
#define IS_RTC_TAMPER_PRECHARGE_DURATION(DURATION)                                                                 \
    (((DURATION) == RTC_TAMPERPRECHARGEDURATION_1RTCCLK) || ((DURATION) == RTC_TAMPERPRECHARGEDURATION_2RTCCLK) || \
     ((DURATION) == RTC_TAMPERPRECHARGEDURATION_4RTCCLK) || ((DURATION) == RTC_TAMPERPRECHARGEDURATION_8RTCCLK))
