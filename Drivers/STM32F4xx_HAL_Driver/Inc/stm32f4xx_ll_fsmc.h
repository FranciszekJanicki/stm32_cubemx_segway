...
#define IS_FSMC_WRITE_FIFO(__FIFO__) (((__FIFO__) == FSMC_WRITE_FIFO_DISABLE) || ((__FIFO__) == FSMC_WRITE_FIFO_ENABLE))
...
#define IS_FSMC_NAND_BANK(__BANK__) (((__BANK__) == FSMC_NAND_BANK2) || ((__BANK__) == FSMC_NAND_BANK3))
...
#define __FSMC_NAND_DISABLE(__INSTANCE__, __BANK__)                                     \
    (((__BANK__) == FSMC_NAND_BANK2) ? CLEAR_BIT((__INSTANCE__)->PCR2, FSMC_PCR2_PBKEN) \
