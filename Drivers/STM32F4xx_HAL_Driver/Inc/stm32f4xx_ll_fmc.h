...
#define IS_FMC_WRAP_MODE(__MODE__) (((__MODE__) == FMC_WRAP_MODE_DISABLE) || ((__MODE__) == FMC_WRAP_MODE_ENABLE))
...
#define IS_FMC_NAND_BANK(__BANK__) (((__BANK__) == FMC_NAND_BANK2) || ((__BANK__) == FMC_NAND_BANK3))
#else
#define IS_FMC_NAND_BANK(__BANK__) ((__BANK__) == FMC_NAND_BANK3)
#endif /* FMC_Bank2_3 */
#define IS_FMC_WAIT_FEATURE(__FEATURE__) \
    (((__FEATURE__) == FMC_NAND_PCC_WAIT_FEATURE_DISABLE) || ((__FEATURE__) == FMC_NAND_PCC_WAIT_FEATURE_ENABLE))
#define IS_FMC_NAND_MEMORY_WIDTH(__WIDTH__) \
    (((__WIDTH__) == FMC_NAND_PCC_MEM_BUS_WIDTH_8) || ((__WIDTH__) == FMC_NAND_PCC_MEM_BUS_WIDTH_16))
...
#define IS_FMC_WRITE_PROTECTION(__WRITE__) \
    (((__WRITE__) == FMC_SDRAM_WRITE_PROTECTION_DISABLE) || ((__WRITE__) == FMC_SDRAM_WRITE_PROTECTION_ENABLE))
...
#define IS_FMC_COMMAND_MODE(__COMMAND__)                                                                \
    (((__COMMAND__) == FMC_SDRAM_CMD_NORMAL_MODE) || ((__COMMAND__) == FMC_SDRAM_CMD_CLK_ENABLE) ||     \
     ((__COMMAND__) == FMC_SDRAM_CMD_PALL) || ((__COMMAND__) == FMC_SDRAM_CMD_AUTOREFRESH_MODE) ||      \
     ((__COMMAND__) == FMC_SDRAM_CMD_LOAD_MODE) || ((__COMMAND__) == FMC_SDRAM_CMD_SELFREFRESH_MODE) || \
     ((__COMMAND__) == FMC_SDRAM_CMD_POWERDOWN_MODE))
#define IS_FMC_COMMAND_TARGET(__TARGET__)                                                            \
    (((__TARGET__) == FMC_SDRAM_CMD_TARGET_BANK1) || ((__TARGET__) == FMC_SDRAM_CMD_TARGET_BANK2) || \
...
#define IS_FMC_SDRAM_BANK(__BANK__) (((__BANK__) == FMC_SDRAM_BANK1) || ((__BANK__) == FMC_SDRAM_BANK2))
#define IS_FMC_COLUMNBITS_NUMBER(__COLUMN__)                                                           \
    (((__COLUMN__) == FMC_SDRAM_COLUMN_BITS_NUM_8) || ((__COLUMN__) == FMC_SDRAM_COLUMN_BITS_NUM_9) || \
     ((__COLUMN__) == FMC_SDRAM_COLUMN_BITS_NUM_10) || ((__COLUMN__) == FMC_SDRAM_COLUMN_BITS_NUM_11))
...
#define IS_FMC_INTERNALBANK_NUMBER(__NUMBER__) \
    (((__NUMBER__) == FMC_SDRAM_INTERN_BANKS_NUM_2) || ((__NUMBER__) == FMC_SDRAM_INTERN_BANKS_NUM_4))
...
#define __FMC_NAND_DISABLE(__INSTANCE__, __BANK__)                                    \
    (((__BANK__) == FMC_NAND_BANK2) ? CLEAR_BIT((__INSTANCE__)->PCR2, FMC_PCR2_PBKEN) \
...
#define __FMC_NAND_CLEAR_FLAG(__INSTANCE__, __BANK__, __FLAG__) \
    (((__BANK__) == FMC_NAND_BANK2) ? ((__INSTANCE__)->SR2 &= ~(__FLAG__)) : ((__INSTANCE__)->SR3 &= ~(__FLAG__)))
#else
...
HAL_StatusTypeDef
FMC_NORSRAM_Timing_Init(FMC_NORSRAM_TypeDef* Device, FMC_NORSRAM_TimingTypeDef* Timing, uint32_t Bank);
...
HAL_StatusTypeDef
FMC_NAND_CommonSpace_Timing_Init(FMC_NAND_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing, uint32_t Bank);
HAL_StatusTypeDef
FMC_NAND_AttributeSpace_Timing_Init(FMC_NAND_TypeDef* Device, FMC_NAND_PCC_TimingTypeDef* Timing, uint32_t Bank);
