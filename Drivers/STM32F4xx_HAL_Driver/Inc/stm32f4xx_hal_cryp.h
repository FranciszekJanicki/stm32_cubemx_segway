...
typedef struct __CRYP_HandleTypeDef {
    ...
    FunctionalState AutoKeyDerivation; /*!< Used only in TinyAES to allows to bypass or not key write-up before
                                       decryption. This parameter can be a value of ENABLE/DISABLE */
...
HAL_StatusTypeDef
HAL_CRYP_Encrypt(CRYP_HandleTypeDef* hcryp, uint32_t* Input, uint16_t Size, uint32_t* Output, uint32_t Timeout);
HAL_StatusTypeDef
HAL_CRYP_Decrypt(CRYP_HandleTypeDef* hcryp, uint32_t* Input, uint16_t Size, uint32_t* Output, uint32_t Timeout);
...
#define IS_CRYP_ALGORITHM(ALGORITHM)                                                                     \
    (((ALGORITHM) == CRYP_DES_ECB) || ((ALGORITHM) == CRYP_DES_CBC) || ((ALGORITHM) == CRYP_TDES_ECB) || \
     ((ALGORITHM) == CRYP_TDES_CBC) || ((ALGORITHM) == CRYP_AES_ECB) || ((ALGORITHM) == CRYP_AES_CBC) || \
     ((ALGORITHM) == CRYP_AES_CTR) || ((ALGORITHM) == CRYP_AES_GCM) || ((ALGORITHM) == CRYP_AES_CCM))
#else /*NO GCM CCM */
#define IS_CRYP_ALGORITHM(ALGORITHM)                                                                     \
    (((ALGORITHM) == CRYP_DES_ECB) || ((ALGORITHM) == CRYP_DES_CBC) || ((ALGORITHM) == CRYP_TDES_ECB) || \
     ((ALGORITHM) == CRYP_TDES_CBC) || ((ALGORITHM) == CRYP_AES_ECB) || ((ALGORITHM) == CRYP_AES_CBC) || \
...
#define IS_CRYP_KEYSIZE(KEYSIZE) \
    (((KEYSIZE) == CRYP_KEYSIZE_128B) || ((KEYSIZE) == CRYP_KEYSIZE_192B) || ((KEYSIZE) == CRYP_KEYSIZE_256B))
#else /* AES*/
#define IS_CRYP_ALGORITHM(ALGORITHM)                                                                    \
