...
typedef void (*pFMPI2C_AddrCallbackTypeDef)(FMPI2C_HandleTypeDef* hfmpi2c,
...
HAL_StatusTypeDef HAL_FMPI2C_Master_Receive(FMPI2C_HandleTypeDef* hfmpi2c,
                                            ...
                                            uint32_t Timeout);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Transmit(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Receive(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t Timeout);
...
HAL_StatusTypeDef HAL_FMPI2C_Mem_Read(FMPI2C_HandleTypeDef* hfmpi2c,
                                      ...
                                      uint32_t Timeout);
HAL_StatusTypeDef
HAL_FMPI2C_IsDeviceReady(FMPI2C_HandleTypeDef* hfmpi2c, uint16_t DevAddress, uint32_t Trials, uint32_t Timeout);

/******* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef
HAL_FMPI2C_Master_Transmit_IT(FMPI2C_HandleTypeDef* hfmpi2c, uint16_t DevAddress, uint8_t* pData, uint16_t Size);
HAL_StatusTypeDef
HAL_FMPI2C_Master_Receive_IT(FMPI2C_HandleTypeDef* hfmpi2c, uint16_t DevAddress, uint8_t* pData, uint16_t Size);
...
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Receive_IT(FMPI2C_HandleTypeDef* hfmpi2c,
                                                   ...
                                                   uint32_t XferOptions);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Seq_Transmit_IT(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t XferOptions);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Seq_Receive_IT(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t XferOptions);
...
HAL_StatusTypeDef
HAL_FMPI2C_Master_Transmit_DMA(FMPI2C_HandleTypeDef* hfmpi2c, uint16_t DevAddress, uint8_t* pData, uint16_t Size);
HAL_StatusTypeDef
HAL_FMPI2C_Master_Receive_DMA(FMPI2C_HandleTypeDef* hfmpi2c, uint16_t DevAddress, uint8_t* pData, uint16_t Size);
...
HAL_StatusTypeDef HAL_FMPI2C_Master_Seq_Receive_DMA(FMPI2C_HandleTypeDef* hfmpi2c,
                                                    ...
                                                    uint32_t XferOptions);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Seq_Transmit_DMA(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t XferOptions);
HAL_StatusTypeDef
HAL_FMPI2C_Slave_Seq_Receive_DMA(FMPI2C_HandleTypeDef* hfmpi2c, uint8_t* pData, uint16_t Size, uint32_t XferOptions);
/**
 * @}
 */
...
#define IS_FMPI2C_GENERAL_CALL(CALL) (((CALL) == FMPI2C_GENERALCALL_DISABLE) || ((CALL) == FMPI2C_GENERALCALL_ENABLE))

#define IS_FMPI2C_NO_STRETCH(STRETCH) \
    (((STRETCH) == FMPI2C_NOSTRETCH_DISABLE) || ((STRETCH) == FMPI2C_NOSTRETCH_ENABLE))

#define IS_FMPI2C_MEMADD_SIZE(SIZE) (((SIZE) == FMPI2C_MEMADD_SIZE_8BIT) || ((SIZE) == FMPI2C_MEMADD_SIZE_16BIT))
...
#define FMPI2C_RESET_CR2(__HANDLE__)                                                                                  \
    ((__HANDLE__)->Instance->CR2 &= (uint32_t)~((uint32_t)(FMPI2C_CR2_SADD | FMPI2C_CR2_HEAD10R | FMPI2C_CR2_NBYTES | \
...
#define FMPI2C_GENERATE_START(__ADDMODE__, __ADDRESS__)                                                             \
    (((__ADDMODE__) == FMPI2C_ADDRESSINGMODE_7BIT)                                                                  \
         ? (uint32_t)((((uint32_t)(__ADDRESS__) & (FMPI2C_CR2_SADD)) | (FMPI2C_CR2_START) | (FMPI2C_CR2_AUTOEND)) & \
                      (~FMPI2C_CR2_RD_WRN))                                                                         \
         : (uint32_t)((((uint32_t)(__ADDRESS__) & (FMPI2C_CR2_SADD)) | (FMPI2C_CR2_ADD10) | (FMPI2C_CR2_START) |    \
                       (FMPI2C_CR2_AUTOEND)) &                                                                      \
                      (~FMPI2C_CR2_RD_WRN)))

#define FMPI2C_CHECK_FLAG(__ISR__, __FLAG__) \
    ((((__ISR__) & ((__FLAG__) & FMPI2C_FLAG_MASK)) == ((__FLAG__) & FMPI2C_FLAG_MASK)) ? SET : RESET)
