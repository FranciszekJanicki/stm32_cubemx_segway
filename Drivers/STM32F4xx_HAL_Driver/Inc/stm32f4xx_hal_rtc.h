...
#define RTC_TR_RESERVED_MASK \
    ((uint32_t)(RTC_TR_HT | RTC_TR_HU | RTC_TR_MNT | RTC_TR_MNU | RTC_TR_ST | RTC_TR_SU | RTC_TR_PM))
...
#define RTC_FLAGS_MASK                                                                                               \
    ((uint32_t)(RTC_FLAG_INITF | RTC_FLAG_INITS | RTC_FLAG_ALRAF | RTC_FLAG_ALRAWF | RTC_FLAG_ALRBF |                \
                RTC_FLAG_ALRBWF | RTC_FLAG_WUTF | RTC_FLAG_WUTWF | RTC_FLAG_RECALPF | RTC_FLAG_SHPF | RTC_FLAG_TSF | \
                RTC_FLAG_TSOVF | RTC_FLAG_RSF | RTC_TAMPER_FLAGS_MASK))
