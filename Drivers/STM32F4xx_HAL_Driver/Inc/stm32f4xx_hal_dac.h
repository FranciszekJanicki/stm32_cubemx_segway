...
#define DAC_TRIGGER_NONE                                                                                          \
    0x00000000UL /*!< Conversion is automatic once the DAC1_DHRxxxx register has been loaded, and not by external \
                    trigger */
...
HAL_StatusTypeDef
HAL_DAC_ConfigChannel(DAC_HandleTypeDef* hdac, const DAC_ChannelConfTypeDef* sConfig, uint32_t Channel);
/**
 * @}
 */
