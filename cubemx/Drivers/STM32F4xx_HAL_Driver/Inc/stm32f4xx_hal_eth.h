...
typedef struct {
    ...
    uint32_t
        SrcAddrCtrl; /*!< Specifies the source address insertion control.
    ...
    uint32_t
        ChecksumCtrl; /*!< Specifies the checksum insertion control.
    ...
    uint32_t InnerVlanCtrl; /*!< Specifies Inner VLAN Tag insertion control only when Inner VLAN is
...
typedef struct {
    ...
    FunctionalState
        Support2KPacket; /*!< Enables or disables the IEEE 802.3as Support for 2K length Packets */
    ...
    FunctionalState CarrierSenseBeforeTransmit; /*!< Enables or disables the Carrier Sense Before
                                                   Transmission in Full Duplex Mode. */

    FunctionalState ReceiveOwn; /*!< Enables or disables the Receive Own in Half Duplex mode. */

    FunctionalState CarrierSenseDuringTransmit; /*!< Enables or disables the Carrier Sense During
                                                   Transmission in the Half Duplex mode */

    FunctionalState RetryTransmission; /*!< Enables or disables the MAC retry transmission, when a
    ...
    uint32_t
        PreambleLength; /*!< Selects or not the Preamble Length for Transmit packets (Full Duplex
                           mode). This parameter can be a value of @ref ETH_Preamble_Length */
    ...
    uint32_t GiantPacketSizeLimit; /*!< Specifies the packet size that the MAC will declare it as
                                      Giant, If it's size is greater than the value programmed in
                                      this field in units of bytes This parameter must be a number
                                      between Min_Data = 0x618 (1518 byte) and Max_Data = 0x3FFF (32
                                      Kbyte). */
    ...
    uint32_t
        ExtendedInterPacketGapVal; /*!< Sets the Extended IPG between Packet during transmission.
    ...
    uint32_t PauseTime; /*!< This field holds the value to be used in the Pause Time field in the
                           transmit control packet. This parameter must be a number between Min_Data
                           = 0x0 and Max_Data = 0xFFFF.*/

    FunctionalState ZeroQuantaPause; /*!< Enable or disables the automatic generation of Zero Quanta
                                        Pause Control packets.*/

    uint32_t PauseLowThreshold; /*!< This field configures the threshold of the PAUSE to be checked
                                   for automatic retransmission of PAUSE Packet. This parameter can
                                   be a value of @ref ETH_Pause_Low_Threshold */

    FunctionalState TransmitFlowControl; /*!< Enables or disables the MAC to transmit Pause packets
                                            in Full Duplex mode or the MAC back pressure operation
                                            in Half Duplex mode */
    ...
    FunctionalState
        ReceiveFlowControl; /*!< Enables or disables the MAC to decodes the received Pause packet
    ...
    FunctionalState ForwardRxUndersizedGoodPacket; /*!< Enables or disables  forwarding Undersized
                                                      Good Packets.*/
...
typedef struct {
    uint32_t
        DMAArbitration; /*!< Sets the arbitration scheme between DMA Tx and Rx
                                      This parameter can be a value of @ref ETH_DMA_Arbitration */

    FunctionalState AddressAlignedBeats; /*!< Enables or disables the AHB Master interface address
                                            aligned burst transfers on Read and Write channels  */

    uint32_t BurstMode;                          /*!< Sets the AHB Master interface burst transfers.
                                                           This parameter can be a value of @ref ETH_Burst_Mode */
    FunctionalState DropTCPIPChecksumErrorFrame; /*!< Selects or not the Dropping of TCP/IP Checksum
                                                    Error Frames */
    ...
    uint32_t TxDMABurstLength; /*!< Indicates the maximum number of beats to be transferred in one
                                  Tx DMA transaction. This parameter can be a value of @ref
    ...
    uint32_t RxDMABurstLength; /*!< Indicates the maximum number of beats to be transferred in one
                                  Rx DMA transaction. This parameter can be a value of @ref
    ...
    FunctionalState
        ForwardUndersizedGoodFrames; /*!< Enables or disables the Rx FIFO to forward Undersized
                                        frames (frames with no Error and length less than 64 bytes)
    ...
    FunctionalState SecondFrameOperate; /*!< Selects or not the Operate on second frame mode, which
                                           allows the DMA to process a second frame of Transmit data
                                           even before obtaining the status for the first frame */

    FunctionalState EnhancedDescriptorFormat; /*!< Enables the enhanced descriptor format */

    uint32_t DescriptorSkipLength; /*!< Specifies the number of word to skip between two unchained
                                      descriptors (Ring mode) This parameter must be a number
                                      between Min_Data = 0 and Max_Data = 32 */
...
typedef struct {
    ...
    FunctionalState
        DestAddrInverseFiltering; /*!< Enable or Disable destination address inverse filtering */
...
typedef struct {
    ...
    FunctionalState
        GlobalUnicast; /*!< Enable or Disable Global unicast packet detection in power down mode */
...
#define ETH_DMATXDESC_ES                                                                         \
    0x00008000U /*!< Error summary: OR of the following bits: UE || ED || EC || LCO || NC || LCA \
                   || FF || JT */
...
#define ETH_DMARXDESC_ES                                                                         \
    0x00008000U /*!< Error summary: OR of the following bits: DE || OE || IPC || LC || RWT || RE \
                   || CE */
...
#define ETH_TXDMABURSTLENGTH_1BEAT                                                                \
    0x00000100U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 1 */
#define ETH_TXDMABURSTLENGTH_2BEAT                                                                \
    0x00000200U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 2 */
#define ETH_TXDMABURSTLENGTH_4BEAT                                                                \
    0x00000400U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 4 */
#define ETH_TXDMABURSTLENGTH_8BEAT                                                                \
    0x00000800U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 8 */
#define ETH_TXDMABURSTLENGTH_16BEAT                                                               \
    0x00001000U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 16 */
#define ETH_TXDMABURSTLENGTH_32BEAT                                                               \
    0x00002000U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_4BEAT                                                          \
    0x01000100U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 4 */
#define ETH_TXDMABURSTLENGTH_4XPBL_8BEAT                                                          \
    0x01000200U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 8 */
#define ETH_TXDMABURSTLENGTH_4XPBL_16BEAT                                                         \
    0x01000400U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 16 */
#define ETH_TXDMABURSTLENGTH_4XPBL_32BEAT                                                         \
    0x01000800U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 32 */
#define ETH_TXDMABURSTLENGTH_4XPBL_64BEAT                                                         \
    0x01001000U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 64 */
#define ETH_TXDMABURSTLENGTH_4XPBL_128BEAT                                                        \
    0x01002000U /*!< maximum number of beats to be transferred in one TxDMA (or both) transaction \
                   is 128 */
/**
 * @}
 */
...
#define ETH_PASSCONTROLFRAMES_FORWARDALL                                                          \
    0x00000080U /*!< MAC forwards all control frames to application even if they fail the Address \
                   Filter */
