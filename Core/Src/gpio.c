...
void MX_GPIO_Init(void)
{
    ...
    HAL_GPIO_WritePin(GPIOA,
                      MOT2_MS2_Pin | MOT2_MS3_Pin | MOT2_DIR_Pin | MOT1_MS3_Pin | MOT1_MS2_Pin | MOT1_MS1_Pin,
                      GPIO_PIN_RESET);
    ...
    GPIO_InitStruct.Pin = MOT2_MS2_Pin | MOT2_MS3_Pin | MOT2_DIR_Pin | MOT1_MS3_Pin | MOT1_MS2_Pin | MOT1_MS1_Pin;
